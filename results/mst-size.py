...
text = Path("mst-size.bench").read_text()
...
add('Kruskal',         0.5, "brown", "-.")
add('KruskalCounting', 0.5, "black", "-.")

add('Kruskal2Heap',    0.5, "red", ":")
add('KruskalD8Heap',   0.5, "blue", ":")
add('KruskalD16Heap',  0.5, "green", ":")
#add('KruskalD32Heap',  0.5, "k", ":")
add('KruskalD64Heap',  0.5, "purple", ":")
#add('KruskalFHeap',    0.5, "k", ":")

add('Prim2Heap',   0.5, "red", "-")
add('PrimD8Heap',  0.5, "blue", "-")
add('PrimD16Heap', 0.5, "green", "-")
#add('PrimD32Heap', 0.5, "k", "-")
add('PrimD64Heap', 0.5, "purple", "-")
#add('PrimFHeap',   0.5, "k", "-")

#add('Edmonds2Heap',   0.5, "k", "--")
#add('EdmondsD8Heap',  0.5, "k", "--")
#add('EdmondsD16Heap', 0.5, "k", "--")
#add('EdmondsD32Heap', 0.5, "k", "--")
#add('EdmondsD64Heap', 0.5, "k", "--")
#add('EdmondsFHeap',   0.5, "k", "--")
...
#plt.show()
plt.savefig('mst-size.pdf', bbox_inches='tight')
